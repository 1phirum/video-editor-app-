...
#include "../../../src/app/video_preview_helper.h"
...
template <> constexpr inline auto VideoPreviewHelper::qt_create_metaobjectdata<qt_meta_tag_ZN18VideoPreviewHelperE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<QVariant>(7, 0x80000000 | 4, QMC::DefaultPropertyFlags | QMC::EnumOrFlag, 0),
...
void VideoPreviewHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 3: *reinterpret_cast<QVariant*>(_v) = _t->activeSubtitle(); break;
        case 4: *reinterpret_cast<QString*>(_v) = _t->activeClipId(); break;
        case 5: *reinterpret_cast<int*>(_v) = _t->uiTickInterval(); break;
        default: break;
        }
    }
}
