...
Item {
    ...
    // ---- Density gates --------------------------------------------------
    readonly property bool showFilmstrip: !root.lightweight
                                          && !root.isAudio && !root.isSubtitle
                                          && root.filmstripUrl !== ""
                                          && root.frameCount > 0
                                          && root.width >= Theme.clipMinThumbWidth
    readonly property bool showWaveform: !root.lightweight
                                         && root.waveformUrl !== "" && !root.isSubtitle
                                         && (root.isAudio
