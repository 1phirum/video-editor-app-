...
Rectangle {
    ...
    function setZoom(value) {
        fitMode = false
        pps = Math.max(minPps, Math.min(maxPps, value))
    }
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Item {
                    ...
                    width: 96
                    height: 16
                    readonly property real range: Math.max(0.001, root.maxPps - root.minPps)
        ...
        Item {
            ...
            readonly property real tickIntervalSec: root.niceTickInterval(72 / Math.max(root.pps, 0.001))
            readonly property real tickPx: tickIntervalSec * root.pps
            readonly property real tickSubdivisionSec: tickIntervalSec / 5
            ...
            Rectangle {
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        readonly property bool majorTick: tickIndex % 5 === 0
                        readonly property bool mediumTick: tickIndex % 5 === 2
                        ...
                        Text {
                            ...
                            x: 3
                            y: 2
                            text: root.fmtTC(tickIndex * body.tickSubdivisionSec)
                        ...
                        Rectangle {
                            anchors.bottom: parent.bottom
                            width: 1
                            height: parent.majorTick ? 10
                                     : parent.mediumTick ? 7 : 4
            ...
            Flickable {
                ...
                contentWidth: Math.max(
                                  width,
                                  body.laneX + root.sequenceSeconds * root.pps
                                  + (root.fitMode ? 0 : 48))
                    ...
                    Item {
                        ...
                        DropArea {
                            ...
                            function updateTarget(event) {
                                ...
                                if (!source) {
                                    targetTrack = ""
                                } else if (!timelineHasMedia()) {
                                    targetTrack = defaultTrackForMedia(
                            ...
                            onEntered: (drag) => updateTarget(drag)
                            ...
                            onDropped: (drop) => {
                                ...
                                Qt.callLater(function() {
                                    Backend.beginTimelinePlacement(pendingIds,
                                                                   pendingStartMs,
                                                                   pendingTrack)
                                })
                            }
